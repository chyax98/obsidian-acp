...
|:----:|:-------:|---------|----------:|:----:|:------:|:-----|
| 1 | T01 | 项目初始化与依赖配置 | 8k | - | ✅ | 🟠 执行中 (Claude-Terminal-E947, 2025-12-18 14:25) |
| 1 | T02 | ACP 类型定义 | 12k | - | ✅ |
| 1 | T03 | Agent 后端配置 | 10k | - | ✅ |
| 1 | T04 | CLI 检测器 | 15k | T03 | ⚠️ |
| 2 | T05 | AcpConnection 核心类 | 25k | T02 | ❌ |
| 2 | T06 | 请求/响应队列管理 | 18k | T05 | ❌ |
| 2 | T07 | 会话生命周期管理 | 15k | T06 | ❌ |
