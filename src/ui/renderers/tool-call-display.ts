...
export class ToolCallDisplayHelper {
	...
	private static formatExecuteTitle(title: string, kind: string): { title: string } {
	...
	private static formatEditTitle(rawInput: Record<string, unknown>, title: string): { title: string } {
		const path = (rawInput.path || rawInput.file_path || title) as string;
		if (path) {
	...
	private static formatSearchTitle(rawInput: Record<string, unknown>): { title: string } {
	...
	private static formatListTitle(rawInput: Record<string, unknown>): { title: string } {
	...
	private static formatMcpTitle(rawInput: Record<string, unknown>): { title: string } {
	...
	private static formatWebSearchTitle(rawInput: Record<string, unknown>): { title: string } {
	...
	private static formatDefaultTitle(title: string, kind: string): { title: string } {
		if (title) {
